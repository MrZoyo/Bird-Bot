...
# Full-button state/style flows are covered with the real lifecycle/database in test_invitation_lifecycle.py.


# Empty-invitation handling is covered with the real database in test_invitation_lifecycle.py.
