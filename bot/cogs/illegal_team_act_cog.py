# bot/cogs/illegal_team_act_cog.py
import discord
...
class IllegalTeamActCog(commands.Cog):
    ...
    async def check_channel_validity(self, ctx_or_interaction, allowed_channel_id=None):
        """
        Maintained for backward compatibility - delegates to utility function
        """
        return await check_channel_validity(ctx_or_interaction, allowed_channel_id)
